...
public class ProductFiltersListAdapter extends BaseExpandableListAdapter implements View.OnClickListener {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (mFilterTypeList.get(groupPosition).equals("Brands")||mFilterTypeList.get(groupPosition).equals("Partners")) {
            holder.tvFilterType.setVisibility(View.GONE);
            holder.viewDivFilter.setVisibility(View.GONE);
        }else {
            holder.tvFilterType.setVisibility(View.VISIBLE);
            holder.viewDivFilter.setVisibility(View.VISIBLE);
        }
        if (mFilterTypeList.get(groupPosition).equals("Price Range")) {
            holder.viewDivFilter.setVisibility(View.GONE);
        }
        return view;
    }
