	...
	public boolean onNavigationItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case R.id.nav_invite:
				if (mAppSharedPreference.getBoolean(PreferenceKeys.KEY_LOGGED_IN, false)) {
					if (mAppSharedPreference.getString(PreferenceKeys.KEY_IS_EMAIL_VERIFIED, "0").equalsIgnoreCase("1")) {
						String shareBody = "Use my share code " + mAppSharedPreference.getString(PreferenceKeys.MY_SHARE_CODE, "") + " to register.\n";
			...
			case R.id.tv_invite_friends:
				if (mAppSharedPreference.getBoolean(PreferenceKeys.KEY_LOGGED_IN, false)) {
					if (mAppSharedPreference.getString(PreferenceKeys.KEY_IS_EMAIL_VERIFIED, "0").equalsIgnoreCase("1")) {
						...
						String shareBody = "Hey guys, I found this cool app called FitStreet which reward you in real cash for being fit and stylish, check it out. Use my code: " + mAppSharedPreference.getString(PreferenceKeys.MY_SHARE_CODE, "") + "\n https://play.google.com/store/apps/details?id=com.fitstreet";
						String shareSubject = getString(R.string.app_name);
						AppUtilMethods.openTextShareDialog(this, shareSubject, shareBody);
